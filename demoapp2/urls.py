...
#     url(r'^query/(?P<change>.+)$', try1, name='try1'),
     url(r'^halfhour_single/(?P<param>.+)$', halfhour_single, name='halfhour_single'),
     url(r'^halfhour_day/(?P<param>.+)$', halfhour_day, name='halfhour_day'),
     url(r'^day_single/(?P<param>.+)$', day_single, name='day_single'),
     ...
     url(r'^halfhour/any/(?P<dt1>.+)/(?P<dt2>.+)$', halfhour_any_month, name='halfhour_any_month'),
     url(r'^halfhour/(?P<day>.+)/(?P<dt1>.+)/(?P<dt2>.+)$', halfhour_particularday, name='halfhour_particularday'),
